...
public class DailyBudgetScreen extends javax.swing.JPanel {
    ...
    private void populateData(String startDate, String endDate) {
        budgetController.populateTable(dailyBudgetTable, startDate, endDate);
    ...
    public void onTableClicked() {
        ...
        if (budget.isStatus()) {
            JOptionPane.showMessageDialog(null, "Sorry the budget for the day has been closed");
            return;
        }
        ...
        jPanel37Layout.setVerticalGroup(
            ...
            .addGroup(jPanel37Layout.createSequentialGroup()
                .addGroup(jPanel37Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lbl_SearchIcon1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
